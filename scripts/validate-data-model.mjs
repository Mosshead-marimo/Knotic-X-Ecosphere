...
for (const event of ["session.created", "turn.accepted", "turn.completed", "response.interrupted", "requirement.updated", "memory.updated", "objection.updated", "qualification.updated", "operation.updated", "session.ended"]) requireText(event, "missing event lifecycle");

for (const requirement of ["FR-04", "FR-05", "FR-07", "FR-11", "FR-12", "FR-13", "FR-14"]) requireText(`| ${requirement} `, "missing requirement trace");
